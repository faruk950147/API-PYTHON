# Generated by Django 4.2.16 on 2026-04-16 09:00
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'otp',
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['user', 'is_used'], name='otp_user_id_42332e_idx'), models.Index(fields=['created_at', 'is_used'], name='otp_created_664604_idx'), models.Index(fields=['ip_address'], name='otp_ip_addr_db0b84_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='user',
